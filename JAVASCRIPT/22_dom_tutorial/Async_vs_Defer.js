...
/*
if you're working with javascript ,it's important to understand to understand the difference between async and defer attributes
 <!-- <script src="./Async_vs_Defer.js"></script>  -->
    ...
    But problem with declaring file here is rest html is not parsed and if js is applied in below tags i may throw error so its bad practice -->
