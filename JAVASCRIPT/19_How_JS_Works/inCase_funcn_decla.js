...
var first_name = "Srushti";
var last_name = "Khatale";
...
6.var first_name = "Srushti";                               (setting in Global Memory)
7.var last_name = "Khatale";                            (setting in Global Memory)
8.var full_name = first_name + "  " + last_name;          (setting in Global Memory)
9.console.log(full_name);                                  Srushti Khatale. (printed)
                                                   ...
                                                   (After Code Execution)
                                                    ...
                                                    1. first_name : Srushti
                                                    2. last_name : Khatale
                                                    3. full_name : Srushti + " " + Khatale.
                                                    4. myfunction(): (function)->
