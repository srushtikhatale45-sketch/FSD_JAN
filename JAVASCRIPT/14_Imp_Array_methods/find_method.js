...
const users = [
    {userId :1 ,firstName:"srushti",age : 21},
    {userId :2,firstName:"Sakshi",age : 20},
    {userId :3,firstName:"rashmi",age : 23},
    {userId :4,firstName:"radhika",age : 27},
    {userId :5,firstName:"riya",age : 24},
]
